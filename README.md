...
- In [Scrum at Big Tech](https://blog.pragmaticengineer.com/project-management-at-big-tech), Gergely Orosz emphasize the need for software engineers to have autonomy and drive their own projects. In his study, he found that Big Tech companies do not enforce a methodology upon their teams. Instead, they are given the autonomy to decide their own processes - the teams ultimately opt for a standard RFC-like planning process (PRD + ERD that leads to development).
    - Engineers solve problems for the business. They can interpret and come to their own conclusions and solutions.
    - Engineers are interested in the business as a collective entity. They want to learn about how the different vertical functions and interact with non-engineers.
    ...
    - Product Managers are not Project Managers. They are focused on defining the strategy of the team. 
    ...
    - Engineering Managers are responsible for the execution of the strategy - empowering the engineers with the process, tools and knowledge to deliver quality work and solve customer painpoints.
    - Those who do the work should be driving. Engineers carry most of the project management responsibility and should be encouraged to create their own tasks.
